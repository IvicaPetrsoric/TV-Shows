...
class ShowsCell: BaseTableCell {
    ...
    override func setupViews() {
        ...
        showstitle.anchor(top: topAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 13, left: 114, bottom: 0, right: 16), size: .init(width: 0, height: 0))
